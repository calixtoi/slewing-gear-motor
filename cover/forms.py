...
class DesignParametersForm(forms.ModelForm):
    class Meta:
        ...
        labels = {
            ...
            'slewing_ring_ratio_pm401': 'Slewing ring gear ratio — PM401 / Substation (110:1)',
            'slewing_ring_efficiency': 'Slewing ring mechanical efficiency (fraction)',
        ...
        widgets = {
            ...
            'slewing_ring_efficiency': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01'}),
